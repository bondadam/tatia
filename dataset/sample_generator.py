...
def main():
    text1 = multilineinput("Copiez-collez le premier texte ici, puis entrez 'D':\n ")
    text2 = multilineinput("Copiez-collez le second texte là, puis entrez 'D':\n ")
